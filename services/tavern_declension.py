...
NICKNAMES = [
    ...
    "жигуль", "жига", "жмых", "черномазый", "Чума", "чивапчичи", "чел", "чихуахуа",
    "чернослив", "чепушила", "чихарда", "ЧЕРКАШ", "chill", "бот", "ноль", "пробка", "очаг",
    ...
    "Чикаго", "шоколад", "чирик", "чмырь", "шнырь", "Чижовка", "чпоньк", "член", "чуткий",
    "чёткий", "чечетка", "чмо", "чувырло", "чучело", "шаровая молния", "чумачечая весна",
    "жерло", "шмонька", "шлюха", "черепушка", "Чунгачанга", "Чимичанга", "читос", "читер",
    ...
    "пузырик", "позер", "шпана", "шумовая", "щавель", "Шуруповёрт", "Сучаров", "шмальник",
    "чурка", "Овчаров",
]
